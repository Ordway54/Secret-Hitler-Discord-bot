...
## Overview
A Discord bot application written in Python 3 and using the discord.py library. This bot application allows the user to play games of *Secret Hitler* entirely within the Discord client.
